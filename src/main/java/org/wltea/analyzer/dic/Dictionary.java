...
public class Dictionary {
    ...
    private static boolean loadedCustomDictionary = false;
    ...
    private Dictionary() {
        //初始化系统词典
        loadMainDict(null);
        loadSurnameDict(null);
        loadQuantifierDict(null);
        loadSuffixDict(null);
        loadPrepDict(null);
    ...
    public void loadCustomDictionary(CustomDictionary customDictionary) {
        loadMainDict(customDictionary.getMainDictInputStream());
        loadSurnameDict(customDictionary.getSurnameDictInputStream());
        loadQuantifierDict(customDictionary.getQuantifierDictInputStream());
        loadSuffixDict(customDictionary.getSuffixDictInputStream());
        loadPrepDict(customDictionary.getPrepDictInputStream());
        loadStopWordDict(customDictionary.getStopWordDictInputStream());
        loadedCustomDictionary = true;
    }

    public boolean isLoadedCustomDictionary() {
        return loadedCustomDictionary;
    }

    /**
     * 加载主词典及扩展词典
     */
    private void loadMainDict(InputStream inputStream) {
        //建立一个主词典实例
        _MainDict = new DictSegment((char) 0);
        //读取主词典文件
        InputStream is = inputStream == null ? Dictionary.class.getClassLoader().getResourceAsStream(Dictionary.PATH_DIC_MAIN) : inputStream;
        if (is == null) {
     ...
     * 加载姓氏词典
     */
    private void loadSurnameDict(InputStream inputStream) {
        //建立一个姓氏词典实例
        _SurnameDict = new DictSegment((char) 0);
        //读取姓氏词典文件
        InputStream is = inputStream == null ? Dictionary.class.getClassLoader().getResourceAsStream(Dictionary.PATH_DIC_SURNAME) : inputStream;
        if (is == null) {
     ...
     * 加载量词词典
     */
    private void loadQuantifierDict(InputStream inputStream) {
        //建立一个量词典实例
        _QuantifierDict = new DictSegment((char) 0);
        //读取量词词典文件
        InputStream is = inputStream == null ? Dictionary.class.getClassLoader().getResourceAsStream(Dictionary.PATH_DIC_QUANTIFIER) : inputStream;
        if (is == null) {
     ...
     * 加载后缀词典
     */
    private void loadSuffixDict(InputStream inputStream) {
        //建立一个后缀词典实例
        _SuffixDict = new DictSegment((char) 0);
        //读取量词词典文件
        InputStream is = inputStream == null ? Dictionary.class.getClassLoader().getResourceAsStream(Dictionary.PATH_DIC_SUFFIX) : inputStream;
        if (is == null) {
     ...
     * 加载介词\副词词典
     */
    private void loadPrepDict(InputStream inputStream) {
        //建立一个介词\副词词典实例
        _PrepDict = new DictSegment((char) 0);
        //读取量词词典文件
        InputStream is = inputStream == null ? Dictionary.class.getClassLoader().getResourceAsStream(Dictionary.PATH_DIC_PREP) : inputStream;
        if (is == null) {
     ...
     * 加载停止词词典
     */
    private void loadStopWordDict(InputStream inputStream) {
        //建立一个停止词典实例
        _StopWords = new DictSegment((char) 0);
        //读取量词词典文件
        InputStream is = inputStream == null ? Dictionary.class.getClassLoader().getResourceAsStream(Dictionary.PATH_DIC_STOP) : inputStream;
        if (is == null) {
